package com.bidgelab.fileio.uc3;
...
public class JavaIOUC3 {

	static Scanner sc;
	static String path = "D:\\JavaPratice\\Day27";

	public void createNewFilesWithUserInput() {
		sc = new Scanner(System.in);
		System.out.print("Enter the desired name of your file: "); // Enter the filename with .extension
	...
	public static void main(String[] args) {
		...
		JavaIOUC3 services = new JavaIOUC3();
